...
if($category == "fruits")
{
    $sql = "UPDATE users SET fruit_wallet = fruit_wallet + $daily_income, today_income = today_income + $daily_income, total_income = total_income + $daily_income WHERE id = $user_id";
    $db->sql($sql); 
}
